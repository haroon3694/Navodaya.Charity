...
export default function StatCounter({ count, suffix = '', label, start, valueColor = '#fff', labelColor = '#A8BBB0', valueSize = 'clamp(2.6rem,4.6vw,3.6rem)' }) {
  const display = useCountUp(count, { suffix, start });
  return (
